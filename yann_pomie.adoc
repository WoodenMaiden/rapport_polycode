...
Afin de gérer l'authentification dans notre application snous allons mettre en place un cluster Keycloak. Keycloak est un _identity provider_ OpenID Connect et SAML 2.0. Il permet de gérer les utilisateurs, les droits d'accès, les sessions, les tokens d'accès et d'autres. Dans notre cas nous allons nous contenter de l'authentification de nos utilisateurs et de leur connection.
...
Vous pouvez remarquer que quite à des problèmes techniques et à un manque de temps un _proof of contept_ fonctionnel n'est pas disponible. Veuillez nous excuser pour ce manque.
