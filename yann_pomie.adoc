...
. Authentification : permet à l'utilisateur de s'inscrire et de s'identifier sur la plateforme.
. Authorisation : Vérifie les droits de l'utilisateur sur une ressource.
